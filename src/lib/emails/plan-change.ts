...
export function planChangeEmail(
  ...
  const summary = newPlan === 'pro_subscriber'
    ? "You now have full access to the video library, plus this month's live webinar with Tapas and the full recording archive."
    : "You now have full access to the video library.";
