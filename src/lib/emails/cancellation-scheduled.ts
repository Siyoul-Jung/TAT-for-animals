...
// Sent the moment a cancellation is scheduled (Stripe portal / dashboard),
// not when it actually takes effect — that's cancellation.ts, which fires
// weeks later at period end. Without this one, a member who cancels gets no
// confirmation at all until the period genuinely ends.
